...
AMyProjectProjectile::AMyProjectProjectile() 
{
	...
	SetReplicatingMovement(true); // 进一步保证位置同步
}
...
void AMyProjectProjectile::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
	...
	GetWorld()->GetTimerManager().SetTimer(
		TimerHandle_DelayedDestroy, this, &AMyProjectProjectile::DelayedDestroy, 0.01f, false);
}

void AMyProjectProjectile::DelayedDestroy()
{
	// 清理定时器
	GetWorld()->GetTimerManager().ClearTimer(TimerHandle_DelayedDestroy);
